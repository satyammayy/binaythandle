...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M) => __awaiter(this, void 0, void 0, function* () {
            if (!M.urls.length)
                return void M.reply(`Please provide the Spotify Track URL that you want to download`);
            const url = M.urls[0];
            ...
            M.reply(yield request_1.default.buffer(info === null || info === void 0 ? void 0 : info.cover_url), baileys_1.MessageType.image, undefined, undefined, caption).catch(() => M.reply(caption));
            M.reply(yield track.getAudio(), baileys_1.MessageType.audio);
        });
    }
}
