...
const chess_image_generator_1 = __importDefault(require("chess-image-generator"));
            ...
            switch (args[0].toLowerCase()) {
                ...
                case 'accept':
                    ...
                    game.start(print, challenge.challenger, challenge.challengee, () => __awaiter(this, void 0, void 0, function* () {
                        const cig = new chess_image_generator_1.default();
                ...
                case 'move':
                    ...
                    if (args[1] == 'castle') {
                        ...
                        const move = {
                            piece: chess_node_1.genRealMove(to)
                        };
                    ...
                    if (from.length != 2 ||
                        ...
                        isNaN(parseInt(to[1])))
                        return void M.reply("A move's fromTile and toTile must be of the from 'XZ', where X is a letter A-H, and Z is a number 1-8.");
                    const toMove = chess_node_1.genRealMove(to);
                    const fromMove = chess_node_1.genRealMove(from);
