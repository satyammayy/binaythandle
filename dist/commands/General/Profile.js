...
class Command extends BaseCommand_1.default {
    constructor(client, handler) {
        ...
        this.run = (M) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield M.reply(yield request_1.default.buffer(pfp || 'https://upload.wikimedia.org/wikipedia/commons/a/ac/Default_pfp.jpg'), baileys_1.MessageType.image, undefined, undefined, `🎋 *Username: ${username}*\n\n🎫 *About: ${(yield this.client.getStatus(user)).status || 'None'}*\n\n🌟 *XP: ${data.Xp || 0}*\n\n👑 *Admin: ${((_c = (_b = M.groupMetadata) === null || _b === void 0 ? void 0 : _b.admins) === null || _c === void 0 ? void 0 : _c.includes(user)) || false}*\n\n❌ *Ban ${data.ban || false}*`);
        });
    }
}
