...
class WAClient extends baileys_1.WAConnection {
    constructor(config) {
        ...
        this.getAuthInfo = (ID) => __awaiter(this, void 0, void 0, function* () {
            if (fs_1.existsSync(`./${ID}_session.json`))
        ...
        this.saveAuthInfo = (ID) => __awaiter(this, void 0, void 0, function* () {
            ...
            fs_1.writeFileSync(`./${ID}_session.json`, JSON.stringify(this.base64EncodedAuthInfo(), null, '\t'));
        ...
        this.log = (text, error) => {
            console.log(chalk_1.default[error ? 'red' : 'green']('[VOID]'), chalk_1.default.blue(moment_1.default(Date.now() * 1000).format('DD/MM HH:mm:ss')), chalk_1.default.yellowBright(text));
        };
